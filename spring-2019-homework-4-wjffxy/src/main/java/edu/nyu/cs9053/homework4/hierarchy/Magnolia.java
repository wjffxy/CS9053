...
public class Magnolia extends Tree {
    ...
    private static final boolean DEFAULT_ISSEEDENCLOSED = true;

    private static final Type DEFAULT_TYPE = Type.Deciduous;

    private static final boolean DEFAULT_ISEUDICOT = true;

    private static final int HASH_SEVENTEEN = 17;

    private final String color;

    public Magnolia(String name, int age, String color) {
